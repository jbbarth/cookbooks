#
# Cookbook Name:: app_orient-latin.com-test
# Recipe:: default
#
...
app_url  = "forteresses-test.jbbarth.com"
app_servername = "forteresses-test.jbbarth.com"
  ...
  before_migrate do
    bash "install the gemset" do
      ...
      code <<-EOF
        ...
        rvm #{app_rvm} --create
        bundle -v | grep " 1.0" && gem install bundler --pre
